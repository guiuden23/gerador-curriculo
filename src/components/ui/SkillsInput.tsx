    ...
    <div>
        ...
        {skills.map((skill) => (
          ...
          >
            ...
            <button
              ...
              className="text-indigo-400 hover:text-red-500 dark:text-indigo-400"
            >
              ×
            </button>
          </span>
      ...
      <div className="mt-2 flex gap-2">
        <input
          ...
          className="w-full rounded-xl border border-zinc-300 bg-white px-3.5 py-2.5 text-base text-zinc-900 placeholder:text-zinc-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 sm:text-sm dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder:text-zinc-500"
        />
        <button
          type="button"
          onClick={submit}
