  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        className="w-full rounded-2xl border-2 border-dashed border-zinc-300 py-3.5 text-sm font-semibold text-zinc-600 transition-colors hover:border-indigo-400 hover:text-indigo-600 dark:border-zinc-700 dark:text-zinc-400 dark:hover:border-indigo-500 dark:hover:text-indigo-400"
      >
