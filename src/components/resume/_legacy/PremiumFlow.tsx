    ...
    <div className="mx-auto max-w-3xl">
      ...
      {stage === "home" && (
        <div className="space-y-8">
          ...
          <div className="rounded-3xl border-2 border-indigo-500/40 bg-gradient-to-br from-indigo-50 via-white to-white p-6 shadow-lg shadow-indigo-100 dark:border-indigo-500/30 dark:from-indigo-950/40 dark:via-zinc-900 dark:to-zinc-900 dark:shadow-none">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <h2 className="bg-gradient-to-r from-indigo-600 to-violet-600 bg-clip-text text-xl font-bold text-transparent dark:from-indigo-400 dark:to-violet-400">
                🤖 Corrigir com IA
              </h2>
              <span className="inline-flex items-center gap-1.5 rounded-full bg-indigo-100 px-3 py-1 text-xs font-bold uppercase tracking-wide text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300">
            ...
            <button
              ...
              className="mt-5 inline-flex h-13 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 px-10 text-base font-bold text-white shadow-md shadow-indigo-300/50 transition-all hover:from-indigo-700 hover:to-violet-700 hover:shadow-lg dark:shadow-none"
            >
              🤖 Corrigir com IA
            </button>
          </div>
        ...
        <div>
          ...
          <div className="mx-auto mb-6 max-w-xl space-y-4">
            ...
            {typeof correction.fitScore === "number" && (
              <div className="rounded-2xl border border-indigo-200 bg-white p-4 text-left dark:border-indigo-900 dark:bg-zinc-900">
          ...
          <div className="mb-6">
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              <div>
                <div className="mb-3 text-center text-sm font-bold uppercase tracking-wide text-indigo-600 dark:text-indigo-400">
          ...
          <div className="mt-8 flex justify-center">
            <button
              ...
              className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-indigo-600 px-8 text-sm font-semibold text-white transition-colors hover:bg-indigo-700"
            >
