...
export function CoverLetterUpsell() {
  ...
  return (
    <div className="mt-10 w-full max-w-xl rounded-3xl border border-indigo-200 bg-gradient-to-br from-indigo-50 to-white p-6 text-left dark:border-indigo-900 dark:from-indigo-950 dark:to-zinc-900">
